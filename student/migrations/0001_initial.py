# Generated by Django 2.0.5 on 2019-03-20 11:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default='1', max_length=10, verbose_name='状态')),
            ],
        ),
        migrations.CreateModel(
            name='Audition',
            fields=[
                ...
                ('class_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='开课时间')),
                ('salesperson', models.CharField(max_length=20, verbose_name='销售员')),
                ('status', models.CharField(default='3', max_length=10, verbose_name='客户状态：1，代表预留信息；              2，沟通未报试听课；3，代表已报试听课；4, 试听结束未报课程；5，试听结束已报课程')),
                ('signUp_time', models.DateTimeField(default=django.utils.timezone.now, null=True, verbose_name='报名时间')),
            ],
            options={
                'db_table': 'audition',
                'verbose_name': '试听课',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record_time', models.DateTimeField(default=django.utils.timezone.now, null=True, verbose_name='记录日期')),
                ('create_time', models.DateTimeField(default=django.utils.timezone.now, null=True, verbose_name='建档日期')),
                ('status', models.CharField(default='1', max_length=10, verbose_name='客户状态：1，代表预留信息；          2，沟通未报试听课；3，代表已报试听课；4, 试听结束未报课程；5，试听结束已报课程')),
                ('salesperson', models.CharField(max_length=20, verbose_name='销售员')),
