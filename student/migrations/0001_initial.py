# Generated by Django 2.0.5 on 2019-03-02 10:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default='1', max_length=10, verbose_name='课程标识符：1，代表预留信息；          2，沟通未报试听课；3，代表已报试听课；4, 试听结束未报课程；5，试听结束已报课程')),
